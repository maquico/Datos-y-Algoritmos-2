...
- 0 cuando está vacío
- 1 cuando está la letra del usuario
- -1 cunado está la letra del bot
...
#pragma endregion
	public: System::Void MyForm1_Load(System::Object^ sender, System::EventArgs^ e) {
		...
		labelJugadorJugandp->Text = "Está jugando " + labelNomX->Text;
...
void ColocarTagImagen(Button^ boton) 
{
	if (JuegaX) {
		...
		JuegaX = false;
		Juega0 = true;
		labelJugadorJugandp->Text = "Está jugando " + labelNomO->Text;
	}
	else {
